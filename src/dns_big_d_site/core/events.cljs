...
(reg-event-db :set-upload-strategic-goals (fn [db [_ val]] (assoc db :upload-strategic-goals val)))
...
(reg-event-db :set-upload-transition-plan (fn [db [_ val]] (assoc db :upload-transition-plan val)))
(reg-event-db :set-upload-youtube-url (fn [db [_ val]] (assoc db :upload-youtube-url val)))
...
(reg-event-db :reset-upload-form (fn [db _]
                                   (-> db
                                       (assoc :upload-name "")
                                       (assoc :upload-author "")
                                       (assoc :upload-play-style "")
                                       (assoc :upload-strategic-goals "")
                                       (assoc :upload-counters "")
                                       (assoc :upload-weaknesses "")
                                       (assoc :upload-transition-plan "")
                                       (assoc :upload-youtube-url "")
